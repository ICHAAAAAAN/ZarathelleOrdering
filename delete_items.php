...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a href="delete_items.php" class="list-group-item active">Delete Food Items</a>
...
$sql = "SELECT * FROM items f WHERE f.options = 'ENABLE' AND f.R_ID IN (SELECT r.R_ID FROM STORE r WHERE r.M_ID='$user_check') ORDER BY F_ID";
