...
<body>
  ...
  foreach ($_SESSION["cart"] as $keys => $values) {
    ...
    $query = "INSERT INTO orders (item_ID, total_price, quantity, customer_ID) 
              VALUES ('" . $item_ID . "','" . $total_price . "','" . $quantity . "','" . $customer_ID . "')";
  ...
  <?php
    ...
    $url = "http://localhost:3000" . "/catalog/order/create";
