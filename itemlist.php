...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="itemlist.php"><span class="glyphicon glyphicon-cutlery"></span> Food Zone </a></li>
...
$sql = "SELECT * FROM ITEMS WHERE options = 'ENABLE' ORDER BY F_ID";
