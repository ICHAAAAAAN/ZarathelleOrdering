...
<head>
  <title> Guest Signup | Zarathelle PH </title>
   ...
   <p>Get started by creating your account...</p>
    ...
    <div class="container-fluid">
      <div class="col-md-4 col-md-offset-4">
        ...
        <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Create an Account</h3>
          <div class="row">
       ...
       <label style="margin-left: 5px;"><a href="customerlogin.php">Have an account? Login here.</a></label>
