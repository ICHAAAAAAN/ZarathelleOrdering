...
$R_IDsql = "SELECT STORE.R_ID FROM STORE, MANAGER WHERE STORE.M_ID='$user_check'";
...
$query = "INSERT INTO ITEMS(name,price,description,R_ID,images_path) VALUES('" . $name . "','" . $price . "','" . $description . "','" . $R_ID ."','" . $images_path . "')";
...
if (!$success){
  ...
  <script type="text/javascript" src="js/bootstrap.min.js"></script>
    ...
    <div class="jumbotron">
     ...
     <p><a href="store.php"> Click Me </a></p>
