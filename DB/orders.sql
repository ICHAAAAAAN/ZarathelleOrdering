...
--
-- Host: localhost:3306
-- Generation Time: Dec 07, 2022 at 09:47 AM
...
(1, 'akoako', 'ako', 'ako@gmail.com', '12345678901', 'siya', 'qwerty');
...
INSERT INTO `items` (`ID`, `name`, `price`, `description`, `images_path`, `options`) VALUES
(1, 'burjer', 123, 'pagkain to', 'images/burger.jpg', 'ENABLE'),
(2, 'ichan', 123, 'masarap siya pramis', 'images/burger.jpg', 'ENABLE');
...
('musmusmus', 'mus', 'musmus@gmail.com', '09381474797', 'bulacan', 'qwertyuiop');
...
INSERT INTO `store` (`R_ID`, `name`, `email`, `contact`, `address`, `M_ID`, `verified`) VALUES
(1, 'AntStore', 'antatore@gmail.com', '09381474797', 'taguig ', 'musmus', NULL);
