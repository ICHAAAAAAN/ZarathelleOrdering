...
--
-- Host: localhost:3306
-- Generation Time: Nov 26, 2022 at 01:31 PM
...
('akoako', 'ako', 'ako@gmail.com', '12345678901', 'siya', 'qwerty');
...
INSERT INTO `items` (`F_ID`, `name`, `price`, `description`, `R_ID`, `images_path`, `options`) VALUES
...
INSERT INTO `orders` (`order_ID`, `F_ID`, `itemname`, `price`, `quantity`, `order_date`, `username`, `R_ID`) VALUES
(1, 1, 'burjer', 123, 1, '2022-11-26', 'akoako', 1),
(2, 1, 'burjer', 123, 2, '2022-11-26', 'akoako', 1);
...
CREATE TABLE `store` (
  ...
  `contact` varchar(30) CHARACTER SET utf8 NOT NULL,
  `address` varchar(50) CHARACTER SET utf8 NOT NULL,
  `M_ID` varchar(30) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `store` (`R_ID`, `name`, `email`, `contact`, `address`, `M_ID`) VALUES
(1, 'AntStore', 'antatore@gmail.com', '09381474797', 'taguig ', 'musmus');
...
--
ALTER TABLE `items`
  MODIFY `F_ID` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
