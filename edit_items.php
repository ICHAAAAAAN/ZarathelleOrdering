...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		<a href="store.php" class="list-group-item ">My Restaurant</a>
    		<a href="view_food_items.php" class="list-group-item ">View Food Items</a>
    		<a href="add_items.php" class="list-group-item ">Add Food Items</a>
    		<a href="edit_items.php" class="list-group-item active">Edit Food Items</a>
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    $query = mysqli_query($conn, "SELECT * FROM items f WHERE f.R_ID IN (SELECT r.R_ID FROM STORE r WHERE r.M_ID='$user_check') ORDER BY F_ID");
    while ($row = mysqli_fetch_array($query)) {
      ...
      <div class="list-group" style="text-align: center;">
        <?php
      echo "<b><a href='edit_items.php?update= {$row['F_ID']}'>{$row['name']}</a></b>";  
        ?>
      </div>
    ...
    $update = $_GET['update'];
    $query1 = mysqli_query($conn, "SELECT * FROM items WHERE F_ID=$update");
